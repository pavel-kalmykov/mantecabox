...
VALUES ('testfile1a', 'testuser1'),
  ...
  ('testfile2b', 'testuser2');`,
			[]models.File{
				{Name: "testfile1a", Owner: models.User{Username: "testuser1", Password: "testpassword1"}, UserReadable: true, UserWritable: true, GroupReadable: true},
				{Name: "testfile1b", Owner: models.User{Username: "testuser1", Password: "testpassword1"}, UserReadable: true, UserWritable: true, GroupReadable: true},
				{Name: "testfile2a", Owner: models.User{Username: "testuser2", Password: "testpassword2"}, UserReadable: true, UserWritable: true, GroupReadable: true},
				{Name: "testfile2b", Owner: models.User{Username: "testuser2", Password: "testpassword2"}, UserReadable: true, UserWritable: true, GroupReadable: true},
			},
		},
		{
...
func TestFilePgDao_GetByPk(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			testFileInsertQuery,
			args{},
			models.File{Name: "testfile1a", Owner: models.User{Username: "testuser1", Password: "testpassword1"}, UserReadable: true, UserWritable: true, GroupReadable: true},
			false,
		},
		{
...
func TestFilePgDao_Create(t *testing.T) {
	file := models.File{Name: "testfile", Owner: models.User{Username: "testuser1", Password: "testpassword1"},
...
func TestUpdate(t *testing.T) {
	updatedFile := models.File{Name: "updatedfile", Owner: models.User{Username: "testuser1", Password: "testpassword1"}}
